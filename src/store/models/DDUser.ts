...
export const getOrCreateUserById = async (id: bigint) => await Sentry.startSpan(
    ...
    async () => {
        ...
        return await Sentry.startSpan({name: 'DDUser.findOrCreate', attributes: {id: id.toString()}}, async () => {
