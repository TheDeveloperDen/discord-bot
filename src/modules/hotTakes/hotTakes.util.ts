...
function replaceHotTakeThing (
  f: (arg: string) => string, thing: HotTakeThing): HotTakeThing {
...
const placeholders = {
  ...
  oneWordAnything: (users: string[]) => mapPlaceholder('anything',
    it => replaceHotTakeThing(s => s.replace(' ', ''), it))(users),
  ...
  oneWordThing: (users: string[]) => mapPlaceholder('thing',
    it => replaceHotTakeThing(s => s.replace(' ', ''), it))(users)
}
...
function combineSources (...source: Array<NewOmit<keyof typeof hotTakeData, 'takes'>>): (users: string[]) => HotTakeThing[] {
...
function mapPlaceholder (
  key: Placeholder,
  f: (s: HotTakeThing) => HotTakeThing): (users: string[]) => HotTakeThing[] {
